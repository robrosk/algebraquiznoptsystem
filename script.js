...
const next20 = (evnt) => {
    if (document.getElementById('q20').value === '' || document.getElementById('q20p2').value === '') {
        ...
        if (a === 21 && b === 118) {
            ...
            score = score + 100;
            document.getElementById('scoring').innerHTML = 'Correct!';
            ...
            if (score >= 1500) {
                document.getElementById('final-score').innerHTML = `You got ${score / 100}/20 questions correct. Well done!`
            }
            else {
                document.getElementById('final-score').innerHTML = `You got ${score / 100} out of 20 questions correct. Nice!`
            }
        }
        else {
            document.getElementById('final').hidden = false;
